Trestle.resource(:users) do
  ...
  table do
    ...
    actions do |toolbar, instance, admin|
      toolbar.link 'Wallet', admin.path(:wallet, id: instance.id), class: 'btn bg-warning'
      toolbar.link 'Activate', admin.path(:activate, id: instance.id), method: :post,class:"btn bg-success"
      toolbar.link 'Deactivate', admin.path(:deactivate, id: instance.id), method: :post, class: 'btn bg-danger'
    end
  end
